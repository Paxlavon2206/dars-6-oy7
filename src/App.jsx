  ...
  return (
    <div className="container">
      <div className="flex mr-auto ml-auto mb-4 justify-between">
        ...
        <input className="w-[900px] outline-violet-500 border-2 border-violet-300 px-6 py-2" onChange={(e)=> setInput(e.target.value)} value={input} placeholder="Search..." type="text" />
        <div className=" w-11 flex items-center align-middle hover:scale-110">
          <button ><img src={search} alt="icon" /></button>
        </div>
      </div>
      {isLoading ? <Skeleton count={5} /> : <div className="just gap-3">
